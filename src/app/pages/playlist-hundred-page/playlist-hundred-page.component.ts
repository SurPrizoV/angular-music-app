...
@Component({
  ...
  templateUrl: './playlist-hundred-page.component.html',
})
export class PlaylistHundredPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.isLoading = true;
    this.tracksAPIService.getTrackCollectionById(2).subscribe({
      next: (tracks: Track[]) => {
